...
for index_num in range(N):
    ...
    output = fill_depth_colorization(imgRgb=img_RGB_0_to_1, imgDepthInput=imgDepthInput)
    depth_HSV[:,:,0] = output / 4.0 * 180
    depth_HSV[:,:,1] = 200
    depth_HSV[:,:,2] = 200
